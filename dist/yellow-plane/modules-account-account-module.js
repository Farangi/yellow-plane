...
/* harmony import */ var _pages_account_page_account_page_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/account-page/account-page.page */ "./src/app/modules/full-layout/modules/account/pages/account-page/account-page.page.ts");
/* harmony import */ var _pages_account_page_personal_info_account_page_personal_info_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/account-page-personal-info/account-page-personal-info.page */ "./src/app/modules/full-layout/modules/account/pages/account-page-personal-info/account-page-personal-info.page.ts");
/* harmony import */ var _pages_account_page_settings_account_page_settings_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pages/account-page-settings/account-page-settings.page */ "./src/app/modules/full-layout/modules/account/pages/account-page-settings/account-page-settings.page.ts");
/* harmony import */ var _pages_account_page_messages_account_page_messages_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./pages/account-page-messages/account-page-messages.page */ "./src/app/modules/full-layout/modules/account/pages/account-page-messages/account-page-messages.page.ts");
...
var routes = [
    ...
    {
        path: 'page',
        component: _pages_account_page_account_page_page__WEBPACK_IMPORTED_MODULE_5__["AccountPageComponent"],
        children: [
            {
                path: '',
                component: _pages_account_page_personal_info_account_page_personal_info_page__WEBPACK_IMPORTED_MODULE_6__["AccountPagePersonalInfoComponent"],
            },
            {
                path: 'settings',
                component: _pages_account_page_settings_account_page_settings_page__WEBPACK_IMPORTED_MODULE_7__["AccountPageSettingsComponent"],
            },
            {
                path: 'messages',
                component: _pages_account_page_messages_account_page_messages_page__WEBPACK_IMPORTED_MODULE_8__["AccountPageMessagesComponent"],
            }
        ],
    }
];
...
/* harmony import */ var _components_account_header_page_account_header_page_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/account-header-page/account-header-page.component */ "./src/app/modules/full-layout/modules/account/components/account-header-page/account-header-page.component.ts");
/* harmony import */ var _components_account_sidebar_page_account_sidebar_page_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./components/account-sidebar-page/account-sidebar-page.component */ "./src/app/modules/full-layout/modules/account/components/account-sidebar-page/account-sidebar-page.component.ts");
/* harmony import */ var _components_account_sidebar_page_large_account_sidebar_page_large_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./components/account-sidebar-page-large/account-sidebar-page-large.component */ "./src/app/modules/full-layout/modules/account/components/account-sidebar-page-large/account-sidebar-page-large.component.ts");
/* harmony import */ var _pages_account_page_account_page_page__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./pages/account-page/account-page.page */ "./src/app/modules/full-layout/modules/account/pages/account-page/account-page.page.ts");
/* harmony import */ var _pages_account_page_personal_info_account_page_personal_info_page__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./pages/account-page-personal-info/account-page-personal-info.page */ "./src/app/modules/full-layout/modules/account/pages/account-page-personal-info/account-page-personal-info.page.ts");
/* harmony import */ var _pages_account_page_settings_account_page_settings_page__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./pages/account-page-settings/account-page-settings.page */ "./src/app/modules/full-layout/modules/account/pages/account-page-settings/account-page-settings.page.ts");
/* harmony import */ var _pages_account_page_messages_account_page_messages_page__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./pages/account-page-messages/account-page-messages.page */ "./src/app/modules/full-layout/modules/account/pages/account-page-messages/account-page-messages.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AccountModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _components_account_header_page_account_header_page_component__WEBPACK_IMPORTED_MODULE_15__["AccountHeaderPageComponent"],
                _components_account_sidebar_page_account_sidebar_page_component__WEBPACK_IMPORTED_MODULE_16__["AccountSidebarPageComponent"],
                _components_account_sidebar_page_large_account_sidebar_page_large_component__WEBPACK_IMPORTED_MODULE_17__["AccountSidebarPageLargeComponent"],
                _pages_account_page_messages_account_page_messages_page__WEBPACK_IMPORTED_MODULE_21__["AccountPageMessagesComponent"],
                _pages_account_page_account_page_page__WEBPACK_IMPORTED_MODULE_18__["AccountPageComponent"],
                _pages_account_page_personal_info_account_page_personal_info_page__WEBPACK_IMPORTED_MODULE_19__["AccountPagePersonalInfoComponent"],
                _pages_account_page_settings_account_page_settings_page__WEBPACK_IMPORTED_MODULE_20__["AccountPageSettingsComponent"]
            ]
        })
    ], AccountModule);
